...
@Component({
  selector: 'app-nouv-epreuve',
  templateUrl: './nouv-epreuve.component.html',
  styleUrls: ['./nouv-epreuve.component.scss'],
  standalone: true,
    imports: [CommonModule, RouterModule]
})
export class NouvEpreuveComponent implements OnInit {
